...
export default function DanmuManualMatchModal({
  ...
  return createPortal(
    <>
      ...
      <div className='fixed inset-0 z-[2147483647] flex h-dvh min-h-0 max-h-dvh flex-col bg-gray-950/95 pb-[env(safe-area-inset-bottom)] pt-[env(safe-area-inset-top)] dark:bg-slate-950/95 md:inset-auto md:left-1/2 md:top-1/2 md:h-[78vh] md:max-h-[calc(100dvh-2rem)] md:w-[min(96vw,1080px)] md:-translate-x-1/2 md:-translate-y-1/2 md:rounded-2xl md:border md:border-white/20 md:pb-0 md:pt-0 md:shadow-2xl'>
        {/* Header */}
