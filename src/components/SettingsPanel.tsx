...
export const SettingsPanel = memo(({ isOpen, onClose }: SettingsPanelProps) => {
  ...
  const [outroSkipBufferSeconds, setOutroSkipBufferSeconds] = useState(
    DEFAULT_OUTRO_SKIP_BUFFER_SECONDS,
  );
  ...
  useEffect(() => {
    ...
    setOutroSkipBufferSeconds(loadOutroSkipBufferSeconds());
  ...
  const handleOutroSkipBufferSecondsChange = (v: number) => {
    const nextValue = saveOutroSkipBufferSeconds(v);
    setOutroSkipBufferSeconds(nextValue);
  };
  ...
  const handleResetSettings = () => {
    ...
    setOutroSkipBufferSeconds(DEFAULT_OUTRO_SKIP_BUFFER_SECONDS);
    ...
    saveOutroSkipBufferSeconds(DEFAULT_OUTRO_SKIP_BUFFER_SECONDS);
              ...
              <input
                ...
                onChange={(e) =>
                  handleOutroSkipBufferSecondsChange(
                    sanitizeOutroSkipBufferSeconds(e.target.value),
                  )
                }
